(function($) {
	$.fn.initPageRevoke = function(opts) {
		...
		function init(obj) {
			...
			var initRevoke = function(){
				console.log('initiate Revoke.');
				
				dRevoke.click(function(){
